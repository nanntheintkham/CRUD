...
public class Account extends JFrame
{
	...
	{
		DefaultTableModel model = new DBUpdater().getData();
	...
	public Account()
	{
		...
		nametf.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		...
		usertf.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		...
		emailtf.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		...
		Createbtn.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if (Createbtn.getText() == "Create")
				{
					...
					if (DBUpdater.add(nametf.getText(), usertf.getText(), emailtf.getText(), d))
					{
				...
				{
					String id = tableInfo.getValueAt(tableInfo.getSelectedRow(), 0).toString();
					String date = tableInfo.getValueAt(tableInfo.getSelectedRow(), 4).toString();
					
					//Update Data
					if (DBUpdater.Update(id, nametf.getText(), usertf.getText(), emailtf.getText(), date))
					{
	...
	public void TableClick()
	{
		...
		String name = tableInfo.getValueAt(tableInfo.getSelectedRow(), 1).toString();
		String username = tableInfo.getValueAt(tableInfo.getSelectedRow(), 2).toString();
		String email = tableInfo.getValueAt(tableInfo.getSelectedRow(), 3).toString();
		String date = tableInfo.getValueAt(tableInfo.getSelectedRow(), 4).toString();
		nametf.setText(name);
		...
		if (tableInfo.getSelectedColumn() == 6)
		{
